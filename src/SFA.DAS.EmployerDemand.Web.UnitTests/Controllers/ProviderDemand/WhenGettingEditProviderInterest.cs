...
{
    public class WhenGettingEditProviderInterest
    {
        [Test, MoqAutoData]
            ...
            [Greedy] HomeController controller)
        {
            ...
            //Act
            var actual = await controller.EditProviderDetails(ukprn, courseId, id) as ViewResult;
            ...
            [Greedy] HomeController controller)
        {
            ...
            //Act
            var actual = await controller.EditProviderDetails(ukprn, courseId, id) as RedirectToRouteResult;
