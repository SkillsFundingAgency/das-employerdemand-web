...
namespace SFA.DAS.EmployerDemand.Infrastructure.UnitTests.HttpMessageHandlerMock
{
            ...
            httpMessageHandler.Protected()
                .Setup<Task<HttpResponseMessage>>(
                    ...
                    ItExpr.Is<HttpRequestMessage>(c =>
                        ...
                        && c.RequestUri.AbsoluteUri.Equals(url, StringComparison.CurrentCultureIgnoreCase)
                        ),
